...
import entity.R;
import utils.Tools;
import entity.PluginFeedBackDTO;
    ...
    public Suggestions() {
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                String pluginFeedback = feedback.getText();
                frame.dispose();


                try {
                    PluginFeedBackDTO fb = new PluginFeedBackDTO(scoreForPlugin, pluginFeedback);
                    R r = Tools.httpPostHelper(Tools.object2Json(fb), "pluginFeedback");
                    Tools.showMessage(r, panel1);
                } catch (Exception e) {
                    throw new RuntimeException(e);
                }

//                JOptionPane.showMessageDialog(panel1,"Success", "Message", JOptionPane.INFORMATION_MESSAGE);
            }
        });
